            ...
            <div className="lg:w-[45%] bg-[#1a1c29] relative overflow-hidden flex flex-col justify-between p-8 xl:p-14 text-white min-h-[500px] lg:min-h-screen">
                ...
                <div className="relative z-10 max-w-lg mt-10 mb-auto xl:pl-4">
                    ...
                    <p className="text-white/60 text-[15px] xl:text-[16px] mb-10 leading-relaxed max-w-[420px]">
                        Sales, inventory, accounting, operations, and management work from one
                        shared workflow with backend company-code enforcement for client security.
                    </p>
                ...
                <div className="w-full max-w-[400px]">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <p className="text-[14px] text-[#9ca3af]">
                            Sign in with your internal account to access your assigned dashboard.
                        </p>
                    </div>
                    ...
                    <form className="space-y-5" onSubmit={handleSignIn}>
                        <div className="space-y-2">
                            <label className="text-[13px] font-medium text-[#2d2d2d]/80" htmlFor="admin-email">
                                Email Address
                            </label>
                        ...
                        <div className="space-y-2">
                            <label className="text-[13px] font-medium text-[#2d2d2d]/80" htmlFor="admin-password">
                                Password
                            </label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    ...
                    <div className="mt-8 text-center pt-4 border-t border-[#f3f4f6]">
                        ...
                        <p className="text-[11px] text-[#9ca3af]/70 mt-2">
                            Admin roles: {Object.values(ROLE_LABELS)
