    ...
    <div className="min-h-screen flex bg-[#fcfcfc] text-[#2d2d2d] font-sans">
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-auto p-8">
          <div className="mb-6">
            <h1 className="text-[24px] font-semibold text-charcoal leading-tight mb-1">Management Reports</h1>
            <p className="text-[13px] text-muted">Track financial performance, payment exposure, delivery readiness, and approval progress.</p>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                <div className="bg-white border border-[#e5e7eb] rounded-xl p-5 shadow-sm">
                  <div className="flex flex-col mb-4">
                    ...
                    <span className="text-[24px] font-bold text-black">P3,215,800</span>
                  </div>
                ...
                <div className="bg-white border border-[#e5e7eb] rounded-xl p-5 shadow-sm">
                  <div className="flex flex-col mb-4">
                    ...
                    <span className="text-[24px] font-bold text-black">P8,540,200</span>
                  </div>
                  <div className="flex items-center text-[12px]">
                    <TrendingUp className="w-3.5 h-3.5 text-emerald-500 mr-1" />
                ...
                <div className="bg-white border border-[#e5e7eb] rounded-xl p-5 shadow-sm">
                  <div className="flex flex-col mb-4">
                    ...
                    <span className="text-[24px] font-bold text-black">P5,324,400</span>
                  </div>
                  <div className="flex items-center text-[12px]">
                ...
                <div className="h-[350px] w-full mt-4">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <YAxis axisLine={false} tickLine={false} tick={{ fontSize: 11, fill: "#9ca3af" }} tickFormatter={(value) => `P${value / 1000}k`} />
                      <Tooltip
